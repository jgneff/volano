...
rem 64-bit HotSpot Server VM, 64-bit Microsoft C Library, 64-bit JavaService
rem Java 8 Update 5 Server JRE installed in "C:\jdk1.8.0_05" requires:
rem     set JVM_DLL="C:\jdk1.8.0_05\jre\bin\server\jvm.dll"
rem     set MSC_DLL="C:\jdk1.8.0_05\jre\bin\msvcr100.dll"
set JVM_DLL="C:\Program Files\Java\jre8\bin\server\jvm.dll"
set MSC_DLL="C:\Program Files\Java\jre8\bin\msvcr100.dll"
set SERVICE=JavaService64.exe
